<template>
  <div class="container">
    <section class="product-list mt-3">
      <h2 class="text-center text-danger">Các sản phẩm nổi bật</h2>
      <div class="row">
        <div
        v-for="(productItem, index) in productList"
        :key="index"
        class="col-lg-3 mb-2">
          <ProductItem :productItem="productItem" @handle-add-cart="handleAddCart"/>
        </div>
      </div>
    </section>
  </div>
